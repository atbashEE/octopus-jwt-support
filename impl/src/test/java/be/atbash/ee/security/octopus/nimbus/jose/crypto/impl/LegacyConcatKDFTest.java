 ...
 * @version 2015-05-12
 */
public class LegacyConcatKDFTest {
    ...
    public void testGenerateCEK128()
        ...
        assertThat(computedCEK.getEncoded().length * 8).isEqualTo(128);

        assertThat(Arrays.constantTimeAreEqual(cek128, computedCEK.getEncoded())).isTrue();
    }
    ...
    public void testGenerateCIK256()
        ...
        assertThat(computedCIK.getEncoded().length * 8).isEqualTo(256);

        assertThat(Arrays.constantTimeAreEqual(cik256, computedCIK.getEncoded())).isTrue();
    }
    ...
    public void testGenerateCEK256()
        ...
        assertThat(computedCEK.getEncoded().length * 8).isEqualTo(256);

        assertThat(Arrays.constantTimeAreEqual(cek256, computedCEK.getEncoded())).isTrue();
    }
    ...
    public void testGenerateCIK512()
        ...
        assertThat(computedCIK.getEncoded().length * 8).isEqualTo(512);

        assertThat(Arrays.constantTimeAreEqual(cik512, computedCIK.getEncoded())).isTrue();
    }
}
